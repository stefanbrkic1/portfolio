      ...
      <div className="h-auto sm:h-screen sm:min-h-[50rem] px-[3%] sm:px-[9%] py-[2rem] sm:py-[0px] sm:pt-[5rem] flex items-center justify-center">
        <div className="flex flex-col sm:flex-row w-full sm:h-[40rem] shadow-sm">
          <div className="flex-1 bg-[#ffffff] border-b-2 sm:border-b-0 sm:border-r-2 border-primary border-opacity-40 p-[24px] sm:p-[5rem]">
            ...
            <FadeInItem index={3} showOnce={true}>
              <p className="text-primary text-[1.2rem] sm:text-[1.5rem] mt-4 max-w-[23rem]">
                Open source projects, web apps and experimentals.
              </p>
            </FadeInItem>
            <button className="btn-animation group hover:text-[#ffffff] flex justify-center items-center gap-5 w-full sm:w-[26rem] border-2 border-primary mt-[3rem] sm:mt-[7rem] py-[1.1rem] text-primary font-bold text-[1.1rem]">
              <div>SEE MY WORK</div>
              <svg
                viewBox="0 0 100 16"
                fill="none"
          ...
          <div className="flex-1 bg-[#ffffff] p-[24px] sm:p-[5rem]">
            ...
            <button className="hover:bg-primary transition-all duration-200 hover:text-[#ffffff] flex justify-center items-center gap-5 w-full sm:w-[26rem] border-2 border-primary mt-[3rem] sm:mt-[7rem] py-[1.1rem] text-primary font-bold text-[1.1rem]">
              DOWNLOAD
            </button>
          </div>
        </div>
